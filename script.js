...
//sinhala
document.getElementById("sinhala").onclick = function(){
    window.location.href = "sinhala.html";
}
...
document.getElementById("bu").onclick = function() {
    window.location.href = "buddhist.html";
}
...
//civic
document.getElementById("civic").onclick = function() {
...
//tamil
document.getElementById("tam").onclick = function() {
...
//ict
document.getElementById("ict").onclick = function() {
    window.location.href = "ict.html";
}

//helth
document.getElementById("hel").onclick = function() {
    window.location.href = "helth.html";
}
